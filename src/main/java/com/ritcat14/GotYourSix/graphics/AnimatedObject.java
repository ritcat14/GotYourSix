...
public class AnimatedObject extends Sprite {
    ...
    //swimming animations
    public static AnimatedObject fireKingUpSwim       = new AnimatedObject(SpriteSheet.fireKingSwim_up, 32, 32, 2);
    public static AnimatedObject fireKingDownSwim     = new AnimatedObject(SpriteSheet.fireKingSwim_down, 32, 32, 2);
