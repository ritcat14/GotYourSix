...
public class Tile {
    ...
    public static Tile sand = new SpawnGrassTile(Sprite.sand), stone = new SpawnGrassTile(Sprite.stone), wall = new SpawnWallTile(Sprite.wall), wallShad = new SpawnWallTile(Sprite.wallShad),
    						  ...
    						  grassBR = new SpawnEdgeTile(Sprite.grassBR), enemy = new SpawnGrassTile(Sprite.enemy), waterTL = new SpawnEdgeTile(Sprite.waterTL), waterML = new SpawnEdgeTile(Sprite.waterML),
  							  ...
  							  snowStump = new SpawnWallTile(Sprite.snowStump), snowRocks = new SpawnWallTile(Sprite.snowRocks), snowGrave = new SpawnWallTile(Sprite.snowGrave), snowTL = new SpawnEdgeTile(Sprite.snowTL),
  							  snowML = new SpawnEdgeTile(Sprite.snowML), snowBL = new SpawnEdgeTile(Sprite.snowBL), snowTM = new SpawnEdgeTile(Sprite.snowTM), snow = new SpawnFloorTile(Sprite.snow), snowBM = new SpawnEdgeTile(Sprite.snowBM),
                       snowTR = new SpawnEdgeTile(Sprite.snowTR), snowMR = new SpawnEdgeTile(Sprite.snowMR), snowBR = new SpawnEdgeTile(Sprite.snowBR), ice = new SpawnWaterTile(Sprite.ice);
    ...
    public static final int col_sand = 0xffFF0000, col_stone = 0xffFF00AA, col_wall = 0xffFFAA00, col_wallShad = 0xffAA0000, col_crust = 0xffAAAA00, col_wood = 0xffAABB00, col_moss = 0xffAACC00,
  									 ...
  									 col_reed = 0xff432820, col_bush01 = 0xff503527, col_bush02 = 0xff574234, col_rocks = 0xff644941, col_grassGrave = 0xff706C6A, col_lavaGrave = 0xff565452, col_snowStump = 0xff0094FF,
  									 col_snowRocks = 0xff0094AA, col_snowGrave = 0xff0094BB, col_snowTL = 0xff0094CC, col_snowML = 0xff0094DD, col_snowBL = 0xff0094EE, col_snowTM = 0xff1094FF, col_snow = 0xff2194FF,
  								  	 col_snowBM = 0xff3394FF, col_snowTR = 0xff4494FF, col_snowMR = 0xff5594FF, col_snowBR = 0xff6694FF;
